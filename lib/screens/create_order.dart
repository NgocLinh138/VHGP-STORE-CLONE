...
import 'package:store_app/widgets/address/delivery.dart';
    ...
    return Container(
      ...
      child: CupertinoPicker(
        ...
        onSelectedItemChanged: (value) => {
          ...
          //   }
          // }),
          context.read<AppProvider>().changeArea(value + 1),
          setState(() {
            area = context.read<AppProvider>().areaController.text;
          }),
        },
        //context.read<AppProvider>().changeArea(value),
        children: context
            .read<AppProvider>()
            .area
            .map(
  ...
  Widget buildBuildingPicker() {
    return Container(
      ...
      child: CupertinoPicker(
        ...
        itemExtent: 64,
        onSelectedItemChanged: (value) => {
          context.read<AppProvider>().changeBuilding(value),
          setState(() {
